...
$PAGE->set_url('/mod/page_kals/view.php', array('id' => $cm->id));
...
$content = file_rewrite_pluginfile_urls($page->content, 'pluginfile.php', $context->id, 'mod_page_kals', 'content', $page->revision);
