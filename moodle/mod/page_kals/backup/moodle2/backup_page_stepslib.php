...
class backup_page_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $page = new backup_nested_element('page_kals', array('id'), array(
        ...
        // Define sources
        $page->set_source_table('page_kals', array('id' => backup::VAR_ACTIVITYID));

        // Define id annotations
        // (none)

        // Define file annotations
        $page->annotate_files('mod_page_kals', 'intro', null); // This file areas haven't itemid
        $page->annotate_files('mod_page_kals', 'content', null); // This file areas haven't itemid
